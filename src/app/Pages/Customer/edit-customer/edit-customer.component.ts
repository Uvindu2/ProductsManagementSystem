...
customer=new Customer()
  ...
  getCustomer(){
    this.http.get(`http://localhost:8000/customer/${this.cus_id}`).subscribe((res)=>{
  ...
  onSubmit(){
    ...
    this.http.put(`http://localhost:8000/customer/update/${this.cus_id}`,this.customer).subscribe(()=>{
